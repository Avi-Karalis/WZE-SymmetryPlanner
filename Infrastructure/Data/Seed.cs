...
namespace Infrastructure.Data
{
    public static class SeedData
    {
        public static void Seed(ApplicationDbContext context) {
            ...
            WeaponSpecialAbility continuous = new() { Name = "Continuous", Description = "If a Unit Fails an Armor Test against this Weapon, it immediately takes another hit using the Weapon’s DAM Rating (ignoring Aim or other bonuses). A Failed Armor Test against this second hit will not trigger the Continuous Weapon Special Ability." };
            WeaponSpecialAbility divine = new() { Name = "Explosive", ValueX = "1", Description = "This Weapon is subject to the Explosive Area of Effect Weapon rules and has a Threat Zone {X} inches in radius." };
            ...
            WeaponSpecialAbility multiStrike1 = new() { Name = "Multi-strike", ValueX = "1", Description = "For each Strike Action with this Weapon, a Strike Action Test may be assigned to up to {X} Enemy Units." };
            WeaponSpecialAbility multiStrike2 = new() { Name = "Multi-strike", ValueX = "2", Description = "For each Strike Action with this Weapon, a Strike Action Test may be assigned to up to {X} Enemy Units." };
            WeaponSpecialAbility multiStrike3 = new() { Name = "Multi-strike", ValueX = "3", Description = "For each Strike Action with this Weapon, a Strike Action Test may be assigned to up to {X} Enemy Units." };
            ...
            WeaponSpecialAbility reach1 = new() { Name = "Reach", ValueX = "1", Description = "Units armed with this Weapon may perform Strike Actions against Enemy Units in Clear or Obstructed LOS up to {X} inches away, including as part of a Charge Action, even though the Units are not Engaged." };
            WeaponSpecialAbility reach2 = new() { Name = "Reach", ValueX = "2", Description = "Units armed with this Weapon may perform Strike Actions against Enemy Units in Clear or Obstructed LOS up to {X} inches away, including as part of a Charge Action, even though the Units are not Engaged." };
            WeaponSpecialAbility reach3 = new() { Name = "Reach", ValueX = "3", Description = "Units armed with this Weapon may perform Strike Actions against Enemy Units in Clear or Obstructed LOS up to {X} inches away, including as part of a Charge Action, even though the Units are not Engaged." };
            ...
            UnitSpecialAbility shift = new() { Name = "Shift", Description = "This Unit may, as an Action once per its Activation, be removed from the Battlefield and then placed oto the Battlefield at a location up to its MV Rating in inches away in any direction, as long as the location satisfies the Model Placement rules. Removal from the Battlefield does not constitute Movement, but placement does." };
            ...
            Weapon ag17AR = new() { Name = "AG-17 Assault Rifle", ShortRange = 12, ShortRangeDam = 12, ShortRangeMod = 0, LongRange = 36, LongRangeDam = 12, LongRangeMod = -1, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon psg99SR = new() { Name = "PSG-99 Sniper Rifle", ShortRange = 24, ShortRangeMod = 1, ShortRangeDam = 14, LongRange = 48, LongRangeDam = 13, LongRangeMod = 1, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(accurate3) };
            Weapon mg80HMG = new() { Name = "MG-80 HGM", ShortRange = 24, ShortRangeMod = 0, ShortRangeDam = 14, LongRange = 48, LongRangeDam = 13, LongRangeMod = 1, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst3, recoil4) };
            Weapon gehennaPuker = new() { Name = "Gehenna Puker", ShortRange = 10, ShortRangeMod = 3, ShortRangeDam = 13, CritFail = 17, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(continuous, projected) };
            Weapon frags = new() { Name = "Frag Grenades", LongRange = 4, LongRangeDam = 11, LongRangeMod = -1, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive2, indirect) , DynamicRange = true};
            Weapon smokes = new() { Name = "Smoke Grenades", LongRange = 4, LongRangeMod = 0, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(cloud2, indirect, smoke),  DynamicRange = true };
            Weapon mg40LMG = new() { Name = "MG-40 LMG", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 13, LongRange = 36, LongRangeDam = -1, LongRangeMod = 13, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst2, recoil3) };
            Weapon ceremonialBlades = new() { Name = "Ceremonial Blades", CCMod = 2, CCDam = 8, CritFail = 20, DynamicDAM = true, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(reach1) };
            Weapon m13HG = new() { Name = "M13 Handgun", CCMod = 1, CCDam = 12, ShortRange = 6, ShortRangeMod = 0, ShortRangeDam = 12, LongRange = 18, LongRangeDam = 11, LongRangeMod = -2, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon car24SMG = new() { Name = "CAR-24 SMG", ShortRange = 6, ShortRangeMod = 0, ShortRangeDam = 12, LongRange = 18, LongRangeDam = 11, LongRangeMod = -1, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst2) };
            Weapon m516SSG = new() { Name = "M516 Shotgun", ShortRange = 6, ShortRangeMod = 1, ShortRangeDam = 13, LongRange = 18, LongRangeMod = -3, LongRangeDam = 11, CritFail = 20, SRDamageMultiplier = 2, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon m50AR = new() { Name = "M-50 Assault Rifle", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 13, LongRange = 36, LongRangeMod = -2, LongRangeDam = 13, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon dpat9RL = new() { Name = "DPAT-9 Rocket Launcher", ShortRange = 24, ShortRangeMod = -1, ShortRangeDam = 12, LongRange = 48, LongRangeMod = -3, LongRangeDam = 12, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive2, suppressive) };
            Weapon underslungGL = new() { Name = "Underslung Grenade Launcher", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 11, LongRange = 36, LongRangeMod = -1, LongRangeDam = 11, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive2, indirect) };
            Weapon chainripper = new() { Name = "Chainripper", CCMod = -1, CCDam = 13, CCDamageMultiplier = 2, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(continuous, reach1) };
            Weapon bootknife = new() { Name = "Boot Knife", CCMod = 0, CCDam = 4, DynamicDAM = true, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon M606LMG = new() { Name = "M606 LMG", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 13, LongRange = 24, LongRangeMod = -1, LongRangeDam = 13, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst2, recoil3) };
            Weapon csa404Sword = new() { Name = "CSA-404 Sword", CCMod = 1, CCDam = 6, DynamicDAM = true, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(reach1, vicious) };
            Weapon p1000HG = new() { Name = "P1000 Handgun", CCMod = 0, CCDam = 12, ShortRange = 6, ShortRangeMod = 1, ShortRangeDam = 12, LongRange = 18, LongRangeMod = -1, LongRangeDam = 12, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon sasG72001Shotgun = new() { Name = "SA-SG72001 Shotgun", ShortRange = 6, ShortRangeMod = 1, ShortRangeDam = 13, LongRange = 18, LongRangeMod = -2, LongRangeDam = 12, CritFail = 20, SRDamageMultiplier = 2, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon ar3000 = new() { Name = "AR-3000 Assault Rifle", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 13, LongRange = 36, LongRangeMod = -1, LongRangeDam = 13, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon sSW4200PHMG = new() { Name = "SSW4200P HMG", ShortRange = 24, ShortRangeMod = 1, ShortRangeDam = 13, LongRange = 48, LongRangeMod = -2, LongRangeDam = 13, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst3, recoil4) };
            Weapon flashGrenades = new() { Name = "Flash Grenades", LongRange = 4, LongRangeMod = 0, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(concussive, explosive3, indirect), DynamicRange = true };
            Weapon bladeBayonet = new() { Name = "Blade / Bayonet", CCMod = 0, CCDam = 5, DynamicDAM = true, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(thrust3) };
            Weapon aggressorHG = new() { Name = "Aggressor Handgun", CCMod = -1, CCDam = 12, ShortRange = 6, ShortRangeMod = 0, ShortRangeDam = 12, LongRange = 18, LongRangeMod = -3, LongRangeDam = 11, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon interceptorSMG = new() { Name = "Interceptor SMG", ShortRange = 6, ShortRangeMod = 0, ShortRangeDam = 12, LongRange = 18, LongRangeMod = -1, LongRangeDam = 12, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst2) };
            Weapon mandibleSG = new() { Name = "Mandible Shotgun", ShortRange = 6, ShortRangeMod = 0, ShortRangeDam = 14, LongRange = 18, LongRangeMod = -3, LongRangeDam = 12, CritFail = 20, SRDamageMultiplier = 2, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon invaderAR = new() { Name = "Invader Assault Rifle", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 14, LongRange = 36, LongRangeMod = -2, LongRangeDam = 13, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon plasmaCB = new() { Name = "Plasma Carbine", ShortRange = 8, ShortRangeMod = 0, ShortRangeDam = 12, LongRange = 24, LongRangeMod = -1, LongRangeDam = 12, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(continuous, explosive1) };
            Weapon destroyerLMG = new() { Name = "Destroyer LMG", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 14, LongRange = 36, LongRangeMod = -2, LongRangeDam = 13, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst2, recoil4) };
            Weapon chargerHMG = new() { Name = "Charger HMG", ShortRange = 24, ShortRangeMod = 1, ShortRangeDam = 14, LongRange = 48, LongRangeMod = -3, LongRangeDam = 14, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst3, recoil4) };
            Weapon southpawRPG = new() { Name = "Southpaw RPG", ShortRange = 24, ShortRangeMod = -2, ShortRangeDam = 13, LongRange = 48, LongRangeMod = -4, LongRangeDam = 13, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive2, suppressive) };
            Weapon plasmaGrenade = new() { Name = "Plasma Grenade", LongRange = 4, LongRangeMod = -1, LongRangeDam = 12, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive1, continuous, indirect), DynamicRange = true };
            Weapon battleAx = new() { Name = "Battle Axe", CCMod = -1, CCDam = 9, DynamicDAM = true, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(multiStrike2, reach2) };
            Weapon claymore = new() { Name = "Claymore", CCMod = -1, CCDam = 9, DynamicDAM = true, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(thrust2, reach2) };
            Weapon poisonedPunisherShortSword = new() { Name = "Poisoned Punisher Shortsword", CCMod = 1, CCDam = 7, DynamicDAM = true, CritFail = 20, CCDamageMultiplier = 2, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(reach1, vicious) };
            Weapon silencedPunisherHandgun = new() { Name = "Silenced Punisher Handgun", CCMod = -2, CCDam = 12, ShortRange = 6, ShortRangeDam = 13, ShortRangeMod = 0, LongRange = 18, LongRangeDam = 12, LongRangeMod = -2, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(silenced) };
            Weapon windriderSMG = new() { Name = "Windrider SMG", ShortRange = 6, ShortRangeMod = 1, ShortRangeDam = 11, LongRange = 0, LongRangeMod = 0, LongRangeDam = 0, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon airbrushSG = new() { Name = "Airbrush Shotgun", ShortRange = 6, ShortRangeMod = 0, ShortRangeDam = 12, SRDamageMultiplier = 2, LongRange = -3, LongRangeMod = 11, LongRangeDam = 0, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon shogunAR = new() { Name = "Shogun Assault Rifle", ShortRange = 12, ShortRangeMod = 1, ShortRangeDam = 12, LongRange = 36, LongRangeMod = 0, LongRangeDam = 12, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon dragonfireHMG = new() { Name = "Dragonfire HMG", ShortRange = 24, ShortRangeMod = 0, ShortRangeDam = 14, LongRange = 48, LongRangeMod = 0, LongRangeDam = -1, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst3, recoil4) };
            Weapon archerSR = new() { Name = "Archer Sniper Rifle", ShortRange = 24, ShortRangeMod = 2, ShortRangeDam = 13, LongRange = 48, LongRangeMod = 1, LongRangeDam = 13, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(accurate3) };
            Weapon mortisBlade = new() { Name = "Mortis Blade", CCMod = 1, CCDam = 7, CritFail = 20, DynamicDAM = true, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(reach1, vicious) };
            Weapon avengerSword = new() { Name = "Avenger Sword", CCMod = 0, CCDam = 8, CritFail = 20, DynamicDAM = true, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(reach1, thrust2) };
            Weapon delivererBattleBlade = new() { Name = "Deliverer Battleblade", CCMod = -1, CCDam = 9, DynamicDAM = true, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(reach2, thrust2) };
            Weapon silencedNemesisHG = new() { Name = "Silenced Nemesis Handgun", CCMod = -1, CCDam = 11, ShortRange = 6, ShortRangeMod = 1, ShortRangeDam = 11, LongRange = 18, LongRangeMod = 0, LongRangeDam = 11, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(silenced) };
            Weapon avalanceHG = new() { Name = "Avalance Handgun", CCMod = -1, CCDam = 12, ShortRange = 6, ShortRangeMod = 1, ShortRangeDam = 13, LongRange = 18, LongRangeMod = 0, LongRangeDam = 12, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon r75RetributorCB = new() { Name = "R75 Retributor Carbine", ShortRange = 8, ShortRangeMod = 2, ShortRangeDam = 12, LongRange = 24, LongRangeMod = 1, LongRangeDam = 12, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(accurate2) };
            Weapon eruptorLMG = new() { Name = "Eruptor LMG", ShortRange = 12, ShortRangeMod = 1, ShortRangeDam = 13, LongRange = 36, LongRangeMod = 0, LongRangeDam = 12, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst2, recoil3) };
            Weapon eruptorFT = new() { Name = "Eruptor Flamethrower", ShortRange = 10, ShortRangeMod = 3, ShortRangeDam = 11, LongRange = 0, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(continuous, projected) };
            Weapon ac40Justifier = new() { Name = "AC-40 Justifier", CCMod = 1, CCDam = 11, CCDamageMultiplier = 2, SRDamageMultiplier = 2, ShortRange = 10, ShortRangeMod = 2, ShortRangeDam = 12, LongRange = 24, LongRangeMod = 1, LongRangeDam = 12, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon sectionerBayonet = new() { Name = "Sectioner Bayonet", CCMod = 1, CCDam = 5, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(thrust5) };
            Weapon skalakSword = new() { Name = "Skalak Sword", CCMod = 0, CCDam = 7, DynamicDAM = true, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(reach1) };
            Weapon azogar = new() { Name = "Azogar", CCMod = -2, CCDam = 7, DynamicDAM = true, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(multiStrike3, reach2, vicious) };
            Weapon voricheHG = new() { Name = "Voriche Handgun", CCMod = -2, CCDam = 14, ShortRange = 6, ShortRangeMod = 1, ShortRangeDam = 14, LongRange = 18, LongRangeMod = -1, LongRangeDam = 14, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon kratachAR = new() { Name = "Kratach Assault Rifle", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 12, LongRange = 36, LongRangeMod = -1, LongRangeDam = 12, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon belzarachAR = new() { Name = "Belzarach Assault Rifle", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 14, LongRange = 36, LongRangeMod = -2, LongRangeDam = 14, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities() };
            Weapon tormetorFT = new() { Name = "Tormetor Flamethrower", ShortRange = 10, ShortRangeMod = 3, ShortRangeDam = 14, LongRange = 0, CritFail = 17, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(continuous, projected) };
            Weapon incinerator = new() { Name = "Incinerator Flamethrower", ShortRange = 10, ShortRangeMod = 3, ShortRangeDam = 13, LongRange = 0, CritFail = 17, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(continuous, projected) };
            Weapon scytheOfSemai = new() { Name = "Scythe of Semai LMG", ShortRange = 12, ShortRangeMod = 1, ShortRangeDam = 12, LongRange = 36, LongRangeMod = 0, LongRangeDam = 12, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst3, recoil3) };
            Weapon nazgarothHMG = new() { Name = "Nazgaroth HMG", ShortRange = 24, ShortRangeMod = 1, ShortRangeDam = 15, LongRange = 36, LongRangeMod = -1, LongRangeDam = 15, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst3, recoil4) };
            Weapon ashnazgarothHMG = new() { Name = "Ashzazgaroth HMG", ShortRange = 24, ShortRangeMod = 1, ShortRangeDam = 13, LongRange = 36, LongRangeMod = -3, LongRangeDam = 13, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst4, recoil3) };
            Weapon hellblasterLauncher = new() { Name = "Hellblaster Launcher", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 13, LongRange = 36, LongRangeMod = -1, LongRangeDam = 13, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive2, suppressive, vicious) };
            Weapon carcassGrenadeLauncher = new() { Name = "Carcass Grenade Launcher", ShortRange = 12, ShortRangeMod = -1, ShortRangeDam = 11, LongRange = 36, LongRangeMod = -4, LongRangeDam = 11, CritFail = 18, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive2, continuous, indirect) };
            Weapon gasGrenade = new() { Name = "Gas Grenades", LongRange = 4, LongRangeMod = -1, LongRangeDam = 9, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(cloud2, continuous, indirect, smoke), DynamicRange = true };
            Weapon devouringDarkness = new() { Name = "The Devouring Darkness", ShortRange = 18, ShortRangeMod = -4, ShortRangeDam = 4, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(symmetry, terrifying) };
            Weapon necrotalons = new() { Name = "Necrotalons", CCMod = 1, CCDam = 4, DynamicDAM = true, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(flurry2, reach1) };
            Weapon BlutarchHC = new() { Name = "Blutarch Hand Cannon", ShortRange = 6, ShortRangeMod = 0, ShortRangeDam = 15, LongRange = 18, LongRangeMod = -2, LongRangeDam = 14, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(burst2, recoil1) };
            Weapon soulshearer = new() { Name = "Soulshearer", ShortRange = 12, ShortRangeMod = 0, ShortRangeDam = 5, LongRange = 36, LongRangeMod = -2, LongRangeDam = 5, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(gruesome3, terrifying, vicious) };
            Weapon soullessShriek = new() { Name = "Soulless Shriek", ShortRange = 8, ShortRangeMod = 2, ShortRangeDam = 10, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(concussive, projected, symmetry) };
            Weapon handOfDeath = new() { Name = "Hand of Death", ShortRange = 0, ShortRangeMod = 2, ShortRangeDam = 15, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(accurate3, symmetry) };
