...
namespace Infrastructure.Data
{
    public static class SeedData
    {
        public static void Seed(ApplicationDbContext context) {
            ...
            Weapon tormentorFT = new() { Name = "Tormentor Flamethrower", ShortRange = 10, ShortRangeMod = 3, ShortRangeDam = 14, LongRange = 0, CritFail = 17, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(continuous, projected) };
