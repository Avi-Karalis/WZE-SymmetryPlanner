...
namespace Infrastructure.Data
{
    public static class SeedData
    {
        public static void Seed(ApplicationDbContext context) {
            ...
            Weapon frags = new() { Name = "Frag Grenades", LongRange = 4, LongRangeDam = 11, LongRangeMod = -1, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive2, indirect) };
            Weapon smokes = new() { Name = "Smoke Grenades", LongRange = 4, LongRangeMod = 0, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(cloud2, indirect, smoke) };
            ...
            Weapon flashGrenades = new() { Name = "Flash Grenades", LongRange = 4, LongRangeMod = 0, CritFail = 20, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(concussive, explosive3, indirect) };
            ...
            Weapon plasmaGrenade = new() { Name = "Plasma Grenade", LongRange = 4, LongRangeMod = -1, LongRangeDam = 12, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(explosive1, continuous, indirect) };
            ...
            Weapon gasGrenade = new() { Name = "Gas Grenades", LongRange = 4, LongRangeMod = -1, LongRangeDam = 9, CritFail = 19, WeaponWeaponSpecialAbility = Weapon.CreateAbilities(cloud2, continuous, indirect, smoke) };
